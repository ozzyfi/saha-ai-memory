...
export const PilotModal = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const res = await fetch("https://formspree.io/f/xojreplz", {
        method: "POST",
      ...
      toast({
        title: t("modal.err.submit") || "Bir hata oluştu",
        description: t("modal.err.submitDesc") || "Lütfen tekrar deneyin veya doğrudan bizimle iletişime geçin.",
        variant: "destructive",
      });
    } finally {
      setSubmitting(false);
